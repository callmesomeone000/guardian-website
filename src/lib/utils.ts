...
export function getCapabilityColor(state: string): string {
  switch (state) {
    case 'AVAILABLE':
...
export function getCapabilityClass(state: string): string {
  switch (state) {
    case 'AVAILABLE':
...
export function getStatusClass(status: string): string {
  switch (status) {
    case 'WORKING PROTOTYPE':
      return 'status-working-prototype';
    case 'EXPERIMENTAL':
      return 'status-experimental';
    case 'RESEARCH DIRECTION':
      return 'status-research-direction';
    default:
      return 'status-research-direction';
  }
}
